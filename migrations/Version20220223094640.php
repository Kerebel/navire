 ...
 */
final class Version20220223094640 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX indicatif_unique ON pays (indicatif)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX indicatif_unique ON pays');
    }
}
